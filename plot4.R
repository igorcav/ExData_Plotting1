...
par(mfrow = c(2, 2))
plot(datetime, dataSub$Global_reactive_power, type="l", xlab="", ylab="Global Active Power", cex=0.2)
plot(datetime, dataSub$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(datetime, dataSub$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
